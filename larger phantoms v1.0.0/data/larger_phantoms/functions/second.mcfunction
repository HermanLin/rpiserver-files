...
execute as @e[type=phantom,tag=!processed] at @s if score @p lp_rest matches 2400000.. run data merge entity @s {Size:100,Tags:["processed"],Attributes:[{Base:500.0d,Name:"generic.maxHealth"},{Base:5d,Name:"generic.movementSpeed"},{Base:100.0d,Name:"generic.followRange"},{Base:50.0d,Name:"generic.attackDamage"}]}
